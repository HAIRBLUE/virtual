<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        综合楼总共有17楼，一楼是数字交叉创新创业基地等学生社团的主要活动场所；二至四楼分别为财务金融学院、艺术设计学院、酒店管理学院老师的办公场所。党委学生工作部、学生处、党委宣传处、校长办公室等机构也分布在综合楼的其他楼层。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/synthesize1.png'),
        require('../../static/images/synthesize2.png'),
        require('../../static/images/synthesize3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/synthesize.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/sythesize-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
