<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        辅楼主要工作于校园后勤以及大学学生活动，此楼重点包含学生心理服务中心，大家对于大学生活中的各种疑惑从此处能够获得解答。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/synthesize2-1.png'),
        require('../../static/images/synthesize2-2.png'),
        require('../../static/images/synthesize2-3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/synthesize2.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/sythesize2-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
