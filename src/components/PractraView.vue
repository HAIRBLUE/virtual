<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        实训楼相对位于图文信息楼的南侧，正面学校天鹅湖。实训楼有五层，每一层都分布着不同的实训教室，用于学校实际操作的训练基地，是学校产教结合的工作实践的地方。咖啡、茶艺、数据分析等实训课程和活动都在此举办
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/practra1.png'),
        require('../../static/images/practra2.png'),
        require('../../static/images/practra3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/practra.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/practra-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
