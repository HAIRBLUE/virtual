<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        3号教学楼与4号教学楼是毗邻且相通的，是学校单号教室的教学楼，它的第三层与4号教学楼相通的地方是大学生交流活动中心，大学期间的交流活动都在这里进行：素拓本相关事宜等。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/teaching34-1.png'),
        require('../../static/images/teaching34-2.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/teaching34.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/teach34-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
