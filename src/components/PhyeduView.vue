<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        体育馆包含了羽毛球场，乒乓球室，以及二层的舞狮教室，同学们可以在体育馆里进行体育器材的借用，具体位置位于一层，从乒乓球室可以进入器材室。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/phyedu1.png'),
        require('../../static/images/phyedu2.png'),
        require('../../static/images/phyedu3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/phyedu.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/phyedu-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
