<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        足球场位于学校体育馆的东侧，临近学校南门，是大学期间晨跑必经的地方，地方不大却承载了无数的欢声笑语。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/football1.png'),
        require('../../static/images/football2.png'),
        require('../../static/images/football3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/football.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/football-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
