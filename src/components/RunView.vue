<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        田径场基于400米为一圈的规格建设，跑道围绕了真草地所制的足球场，东边有器材室，健身房以及轮滑专用地。晚上有一些同学会在草坪上聚会。学校一些活动也会在这里举办，例如草坪音乐节。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/run1.png'),
        require('../../static/images/run2.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/run.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/run-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
