...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/teaching12-1.png'),
        require('../../static/images/teaching12-2.png'),
        require('../../static/images/teaching12-3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/teaching12.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/teach12-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
