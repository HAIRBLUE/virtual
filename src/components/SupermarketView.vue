<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        天猫超市，位于食堂东侧，超市消费方式支持支付宝和学生卡，使用学生卡消费可享受一定的优惠。超市内不仅提供饮料零食，还供应学生的日常生活用品；
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/supermarket1.png'),
        require('../../static/images/supermarket2.png'),
        require('../../static/images/supermarket3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/supermarket.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/supermarket-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
