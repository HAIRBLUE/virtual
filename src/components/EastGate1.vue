<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        东北1门是学校第二大门，每年迎接新生进校时以及送别大三同学搬进新校区会打开此门，为来自各地的同学提供便捷，基于目前疫情的特殊原因长期处于封闭状态。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/eastgate1-1.png'),
        require('../../static/images/eastgate1-2.png'),
        require('../../static/images/eastgate1-3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/east1.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/eastgate1-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
