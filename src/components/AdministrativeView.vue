<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        行政楼共有六层，是学校老师的工作全区域，学院的相关事件可以在这楼里得到了解，不同的楼层分布着不同学院的相关事务场所。学生事务中心，教师事务中心，考务中心，文印室，监控室，卡务中心（运维）等机构位于一楼
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/administrative1.png'),
        require('../../static/images/administrative2.png'),
        require('../../static/images/administrative3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/administrative.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/Administrative-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
