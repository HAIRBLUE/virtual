<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        南大门靠近学校后面的小食街，同时南门临近四个快递驿站，和一个二手书书店，方便同学们取快递和购买学习资料。奉浦体育中心坐落在不远处，同学们可以去健身游泳，锻炼身体。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/sourthgate1.png'),
        require('../../static/images/sourthgate2.png'),
        require('../../static/images/sourthgate3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/sourthgate.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/sourthgate-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
