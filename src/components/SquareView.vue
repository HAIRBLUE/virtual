<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        北广场位于学校图文信息楼正对的位置，长长的花坛位于广场中央，是学校最大的广场，临近学校北门。面对图文楼站于广场中央，左侧是1，2号教学楼；右侧是行政楼以及3，4号教学楼。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/square1.png'),
        require('../../static/images/square2.png'),
        require('../../static/images/square3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/square.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/square-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
