...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/cantee1.png'),
        require('../../static/images/cantee2.png'),
        require('../../static/images/cantee3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/cantee.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/cantee-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
