<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        网球场位于3，4号教学楼的西侧，共计2个球场，四周树林环绕，静谧优美。在这里充斥着同学们对于网球运动的热爱和青春的汗水。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/tennis1.png'),
        require('../../static/images/tennis2.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/tennis.mp4")// url地址
          }
        ],
        hls: true,
        poster: '', // 你的封面地址
