<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        图文信息楼一共有5层，位于全学校最中心的位置，一楼包含电子阅览室，广播室，心理咨询室等场所；二楼包含书库，阅览室，自修室；三楼包含数据挖掘实验室；信息与计算机学院办公室，实验准备室等实验室;四楼包含语言室、资料室，语音管理办公室；五楼包含教育技术信息与网络中心以及各类实验室。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/graphic1.png'),
        require('../../static/images/graphic2.png'),
        require('../../static/images/graphic3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/graphic.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/graphic-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
