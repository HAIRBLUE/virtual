<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        篮球场临近于田径场，位于体育馆北面。我校共计9个篮球场地，每学期均会进行篮球比赛，运动健儿们在此挥洒汗水，展示青春的活力。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
        ...
        sources: [
          {
            ...
            src: require("../../static/video/basketball.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/basketball-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
