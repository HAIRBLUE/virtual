<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        东北门位于综合楼南侧。从此门外出，临近韩村路，校园著名小吃一条街位于此路，在韩村路可以品尝到各种特色美食。再向南走是宝龙商业广场，广场内包含有影院，餐厅等，是上商学子出门休闲娱乐的绝佳选择之处。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/eastgate1.png'),
        require('../../static/images/eastgate2.png'),
        require('../../static/images/eastgate3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/east.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/eastgate-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
