<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        北大门是学校最大的门，靠近五号线奉浦大道站，同时北大门门口有共享单车停放，交通便利，是学生通过地铁返校时的首选。北大门西侧是妈妈快递驿站。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/northgate1.png'),
        require('../../static/images/northgate2.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/northgate.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/northgate-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
