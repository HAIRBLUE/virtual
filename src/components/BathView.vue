<template>
  <div>
    ...
    <div class="card">
      ...
      <div class="word">
        学生公寓不配备独立的洗浴室，同学日常的洗浴需到综合浴室，浴室内提供吹风机以及镜子，前往淋浴的同学需刷学生卡进入。开设时间一般为周日至周四的14：00-22：30，周五周六的17：00-22：30。
      </div>
      <div class="wordtwo">
        照片预览
      </div>
...
export default {
  ...
  data() {
    return {
      imgSrc: [
        require('../../static/images/bath1.png'),
        require('../../static/images/bath2.png'),
        require('../../static/images/bath3.png'),
      ],
      startPointX: 0,
      changePointX: 0,
      showIndex: 0,
        ...
        sources: [
          {
            ...
            src: require("../../static/video/bath.mp4")// url地址
          }
        ],
        hls: true,
        poster: require('../../static/images/bath-video.png'), // 你的封面地址
        width: 960, // 播放器宽度
        height: 720, // 高度
